...
I approached it as a real project, mapping it out with clear goals and a tracking system that works for me. _(see Google Sheet below)_
![](https://www.kuzushi.xyz/wp-content/uploads/2020/03/Screen-Shot-2020-03-02-at-20.24.25-1024x640.png)

A bit geeky perhaps, but it's been so helpful for me to map out new techniques this way
...
- Please show at full-speed once at the beginning, and again at the end. No words, let your movements do the walking. Danaher is also guilty of that on his otherwise superb series. (_so far the best example of doing it right I found was on the Ffion Davies Takedown series_)
- Show, tell, show. I love the PEDs (_Performance Enhancing Details_) in all their glory, and the occasional banter, but with some sections we don't ever see it demonstrated at real speed even once.
...
I often extract short footage of some key movements into an animated gifs. The process of identifying what I want to focus on and spending a few minutes making these is itself part of the learning process for me. Sometimes having those gifs on my phones helps me before practice to remember what I wanted to work on.
...
![](https://www.kuzushi.xyz/wp-content/uploads/2020/03/BJJ_LG_4_9_Worm_RDLWormConnection.gif)

_Sometimes no notes are needed_
...
1. _not watched yet_
2. _Watched_
3. _Understood_ _Basic Mechanics_
4. _Got it with Noa (my son and best training partner)_
5. _Can recall and replay it mentally_
6. _works against spazzy whites_
7. _Can teach the basics_
8. _Can teach it in details_
9. _Worked vs experienced players_
10. _Worked in Competition_
11. _Keenan/Andris Level Mastery_
...
The problem was that _nobody at my gym really played_ the lapel guards, so how was I supposed to learn it and learn how to defend it? I made a mental note that after all the Danaher and Lachlan series I bought on BJJ Fanatics, I'd eventually get to the Lapel. And I did!  
...
[Lapel Guard Encyclopedia](https://lapelguard.com/?ref=12) by Keenan ? : **10/10 would recommend!**  
Lapel Stuff by Andris Brunovskis on the [Grappler's Guide](https://grapplersguide.com/) ? : 10/10 would recommend

P.S. : using [Gif Brewery](https://gfycat.com/gifbrewery) to make the animated gifs
