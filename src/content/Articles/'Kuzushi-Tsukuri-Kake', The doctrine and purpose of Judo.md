...
掛ける Kakeru also has multipel uses, most relevant ones here would be : _start (an engine), turn (a switch on), put ( a burden) on someone, catch (a fish in a net, a bear in a trap)_
...
From the Kodokan Judo [website](http://kodokanjudoinstitute.org/en/doctrine/purpose/) :  

[技の原理](http://kodokanjudoinstitute.org/doctrine/purpose/)
...
(the order of the first two is somewhat interchangeable, except that ideally one is **always** in a state of Tsukuri)
